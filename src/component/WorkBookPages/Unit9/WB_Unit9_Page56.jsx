...
import page2 from "../../../assets/imgs/pages/Activity Book/Right Int WB G4 U9 Folder/Right Int WB G4 U9 5-1-20266.png";
import "./WB_unit9.css";
...
const WB_Unit9_Page56 = ({ openPopup }) => {
  return (
    ...
    >
      ...
      <div
        className="q12-9 hover:scale-110 transition"
        style={{ overflow: "visible" }}
      >
        <svg
          width="22"
