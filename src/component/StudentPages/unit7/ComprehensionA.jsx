...
const ComprehensionA = () => {
  const questions = [
    {
      id: 1,
      question: "Was there just one Ice Age?",
      answers: [
        "No, there wasn't.",
        "No, there wasn't",
        "no, there wasn't.",
    ...
    {
      id: 2,
      question: "Were there dinosaurs during the most recent Ice Age?",
      answers: [
        "No, there weren't.",
        "No, there weren't",
        "no, there weren't.",
    ...
    {
      id: 3,
      question: "Were there mammoth elephants during the most recent Ice Age?",
      answers: [
        "Yes, there were.",
        "Yes, there were",
        "yes, there were.",
    ...
    {
      id: 4,
      question: "Was there any change in the weather during an Ice Age?",
      answers: [
        "Yes, there was.",
        "Yes, there was",
        "yes, there was.",
  ...
  return (
    <div className="mb-6 mx-auto">
      <h5 className="header-title-page8-read mb-8">
        ...
        Read and write{" "}
        <span className="text-[#f89631] font-bold">Yes, there was / were.</span>{" "}
        or{" "}
        <span className="text-[#f89631] font-bold">No, there wasn't / weren't.</span>{" "}
        for each question.
      </h5>
