...
const ComprehensionA = () => {
  const questions = [
    {
      question: "Which is the hottest layer?",
      answers: ["thermosphere", "the thermosphere"],
    },
    {
      question: "Which is the coldest layer?",
      answers: ["mesosphere", "the mesosphere"],
    },
    {
      question: "Which is the layer where weather happens?",
      answers: ["troposphere", "the troposphere"],
    },
  ];
          ...
          <div key={i} className="flex flex-col gap-1">
            ...
            <div className="relative flex items-center ml-6">
              <input
                ...
                autoComplete="off"
                style={{ fontSize: "18px" }}
                className={`w-full px-2 py-1 border-b-2 bg-transparent outline-none transition disabled:pointer-events-none
                  ${
                    errors[i] === true
