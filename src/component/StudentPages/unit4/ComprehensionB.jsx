...
import atmosphereImg from "../../../assets/imgs/pages/Class Book/Right 4 Unit 4 Joy Makes a Friend Folder/Page 28/SVG/Asset 24.svg";

const ComprehensionB = () => {
  const wordBank = ["thermosphere", "troposphere", "mesosphere", "stratosphere"];

  const questions = [
    { id: 1, answer: "mesosphere" },
    { id: 2, answer: "thermosphere" },
    { id: 3, answer: "troposphere" },
    { id: 4, answer: "stratosphere" },
  ];
  ...
  const inputPositions = {
    1: { top: "23%", left: "-3%",  width: "40%" },   // يسار فوق - mesosphere
    2: { top: "22%", left: "41%", width: "39%" },   // يمين فوق - thermosphere
    3: { top: "39%", left: "-3%",  width: "36%" },   // يسار تحت - troposphere
    4: { top: "37.5%", left: "35.7%", width: "44%" },   // يمين تحت - stratosphere
  };
