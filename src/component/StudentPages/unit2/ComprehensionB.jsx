...
const ComprehensionB = () => {
  const questions = [
    {
      question: "In the story above, what does the charity do?",
      answers: [
        "This charity helps people find jobs.",
        "This charity helps people find jobs",
      ],
    },
    {
      question: "What sports will they play?",
      answers: [
        "They will play soccer, basketball, and volleyball.",
        "They will play soccer, basketball, and volleyball",
        "They will play soccer, basketball and volleyball.",
        "They will play soccer, basketball and volleyball",
      ],
