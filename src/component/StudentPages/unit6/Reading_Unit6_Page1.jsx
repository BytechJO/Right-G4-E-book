...
// import videoFile from "../../../assets/right grade 4/reading/grade 4 unit 6 page 56-57 reading.mp4";
import "./Reading_Unit6_Page1.css";
// ======================================================

const PAGE_ID = "page-56";
...
const Reading_NewPage = ({ openPopup }) => {
  ...
  const clickableAreas = [
    { x1: 15.11, y1: 31.9, x2: 54.11, y2: 50.6, slice: { startFrom: 2.84,  stopAt: 28.58 } },
    { x1: 55.62, y1: 32.07, x2: 94.03, y2: 50.47, slice: { startFrom: 29.67, stopAt: 54.46 } },
    { x1: 15.11, y1: 82,   x2: 53.52, y2: 96.2,  slice: { startFrom: 55.67, stopAt: 76.07 } },
    { x1: 55.62, y1: 81.9, x2: 93.91, y2: 95.9,  slice: { startFrom: 76.07, stopAt: 99.04 } },
  ];
