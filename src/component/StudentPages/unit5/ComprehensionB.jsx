...
const ComprehensionB = () => {
  const questions = [
    {
      question: "Do astronauts stay at space stations for months?",
      answers: [
        "Yes, they do.",
        "Yes, they do",
      ],
    ...
    {
      question: "What do astronauts study?",
      answers: [
        "The astronauts study about space and the planets.",
        "The astronauts study about space and the planets",
        "They study about space and the planets.",
        "They study about space and the planets",
      ],
    },
  ];
