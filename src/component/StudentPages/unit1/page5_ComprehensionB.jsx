...
const ComprehensionB = () => {
  const wordBank = ["library", "technology", "invent", "cinema"];

  const questions = [
    {
      before: "In the future, the newest piece of",
      after: "will be a small computer that you can wear like a watch.",
      answer: "technology",
    },
    {
      before: "What did Thomas Edison",
      after: "?",
      answer: "invent",
    },
    {
      before: "My sister and I will go to the",
      after: "to study. Do you want to come, too?",
      answer: "library",
    },
    {
      before: "There will be a new movie starting at the",
      after: "tonight.",
      answer: "cinema",
    },
  ];
